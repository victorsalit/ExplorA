# plot4.R - a script for plot4 - subfigures
...
par(mfcol = c(2,2))
# plot11:
plot(twodays$DateTime, twodays$Global_active_power, main = "", xlab = "",
...
# plot 12:
plot(twodays$DateTime, twodays$Voltage, main = "", xlab = "datetime",
     ylab = "Voltage", type = "l")

# plot 22
plot(twodays$DateTime, twodays$Global_reactive_power, main = "", xlab = "datetime",
